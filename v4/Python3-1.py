...
# Briefly, classes have:
	...
	# Intro to Python - class hierchaies, subclassing and method overriding, list comprehensions, modules and CSV file reading
	# https://github.com/timh1203/lsw16v-sprintChallengeIntroPython